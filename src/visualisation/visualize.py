...
def plot_check_df(df, name):
    ...
    plt.show()
    plt.close()
    sns.boxplot(x= 'method', y='stride_length',data=df)
    plt.show()
    ...
    plt.show()
    plt.close()
    sns.boxplot(x= "method", y='clearance',data=df)
    plt.show()
    ...
    plt.show()
    plt.close()
    sns.boxplot( x= "method", y='stride_time',data=df)
    plt.show()
...
plot_check_df(df_sim_right, "sim_right")
plot_check_df(df_sim_left, "sim_left")